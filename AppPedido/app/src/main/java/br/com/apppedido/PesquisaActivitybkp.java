...
public class PesquisaActivitybkp extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        eText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence arg0, int arg1, int arg2,
                                      int arg3) {
                Pesquisar();
                lView.setAdapter(new ArrayAdapter<String>(PesquisaActivitybkp.this, android.R.layout.simple_list_item_1, pesquisa));
            }
        });
    }
